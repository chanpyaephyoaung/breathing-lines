...
const PoemPreviewPost = () => {
   return (
      <div className="grid gap-2 p-3 border border-clr-black">
         <div className="text-2xs w-full flex justify-between">
         ...
         <a href=" " className="justify-self-start text-xs text-clr-primary inline-block underline">
            Breathe more
         </a>
      </div>
   );
